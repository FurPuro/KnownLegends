...
open class GlitchParasite(type: EntityType<out GlitchParasite?>?, level: Level?) : Monster(type!!, level!!), GeoEntity {
    companion object {
        protected val IDLE_ANIM: RawAnimation = RawAnimation.begin().thenLoop("animation.glitch_parasite.idle")
        protected val WALK_ANIM: RawAnimation = RawAnimation.begin().thenLoop("animation.glitch_parasite.walk")
    }
    ...
    private fun <E : GlitchParasite?> idleWalkAnimController(animTest: AnimationTest<E>): PlayState {
